...
public class DesktopApplication1View extends FrameView {
    ...
    public DesktopApplication1View(SingleFrameApplication app) {
        ...
        initComponents();
        DesktopApplication1.getApplication().getMainFrame().setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jMenuItem1.setAction(actionMap.get("showAddDepatmentPanel")); // NOI18N
    ...
    @Action
    public void showAddDepatmentPanel() {
        JFrame mainFrame = DesktopApplication1.getApplication().getMainFrame();
        JInternalFrame department = new NewJInternalFrame();
        mainFrame.add(department);
        department.setVisible(true);
        //department.setLocationRelativeTo(mainFrame);
    }
